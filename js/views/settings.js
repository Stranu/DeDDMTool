...
export function renderSettings(root, api) {
  ...
  root.appendChild(el('p', { class: 'muted', text: 'I personaggi giocanti e i PNG ricorrenti si gestiscono direttamente dalla scheda Iniziativa, con il pulsante "Roster".' }));
